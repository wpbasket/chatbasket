...
export type SaveToDeviceModuleEvents = {
  onSaveComplete: (event: SaveCompleteEvent) => void;
};

declare class SaveToDeviceModule extends NativeModule<SaveToDeviceModuleEvents> {
  /**
...
export default requireNativeModule<SaveToDeviceModule>('SaveToDevice');
