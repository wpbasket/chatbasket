...
const TAB_CONFIG = [
  ...
  {
    name: 'home',
    href: '/personal/home' as const,
    label: 'Home',
    icon: (focused: boolean, color: string) => <IconSymbol name={focused ? 'house.fill' : 'house.fill'} size={25} color={color} />
  },
  {
    name: 'contacts',
    href: '/personal/contacts' as const,
    label: 'Contacts',
    icon: (focused: boolean, color: string) => <FontAwesome6 name={focused ? 'contact-book' : 'contact-book'} size={25} color={color} />
  },
  {
    name: 'profile',
    href: '/personal/profile' as const,
    label: 'Profile',
