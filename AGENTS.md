...
This project is indexed by GitNexus as **chatbasket** (2930 symbols, 7575 relationships, 242 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
