...
This project is indexed by GitNexus as **chatbasket** (3879 symbols, 8274 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
