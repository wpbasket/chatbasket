...
This project is indexed by GitNexus as **chatbasket** (3110 symbols, 8099 relationships, 258 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
