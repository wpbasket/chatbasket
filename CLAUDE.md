...
This project is indexed by GitNexus as **chatbasket** (3015 symbols, 7830 relationships, 249 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
