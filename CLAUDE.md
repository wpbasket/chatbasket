...
This project is indexed by GitNexus as **chatbasket** (3007 symbols, 7814 relationships, 249 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
